export declare const PATIENT_GENDERS: readonly ["ذكر", "أنثى"];
...
export type PatientInput = Pick<Patient, "fullName" | "phone" | "dateOfBirth" | "gender"> & Partial<Pick<Patient, "nationalId" | "bloodType" | "address" | "heightCm" | "weightKg" | "emergencyContactName" | "emergencyContactPhone" | "notes">>;
...
export type AppointmentStatus = "BOOKED" | "ARRIVED" | "WAITING" | "WITH_DOCTOR" | "COMPLETED" | "NO_SHOW" | "CANCELLED" | "POSTPONED";
...
export type VitalSignsInput = Omit<VitalSigns, "id" | "bmi" | "measuredByName" | "measuredAt">;
export type MedicalVisitInput = Pick<MedicalVisit, "appointmentId" | "visitReason" | "symptoms" | "clinicalNotes" | "treatmentPlan" | "educationInstructions" | "followupPlan" | "completedAt"> & {
    diagnoses: Array<Pick<Diagnosis, "name" | "code" | "diagnosisType" | "notes">>;
};
